...
class TricksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trick" do
    assert_difference('Trick.count') do
      post tricks_url, params: { trick: { description: @trick.description, difficulty: @trick.difficulty, name: @trick.name, person: @trick.person, picture: @trick.picture } }
    end
  ...
  test "should update trick" do
    patch trick_url(@trick), params: { trick: { description: @trick.description, difficulty: @trick.difficulty, name: @trick.name, person: @trick.person, picture: @trick.picture } }
